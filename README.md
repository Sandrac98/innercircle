...
* someone who is a fan of K-Pop Music.
...
* As a first-time visitor to the site, I want to easily find my way around. 
...
* As a user, I want to know what to expect at an event. 
    - A user can find out more about what to  expect at an event, by navigate to the "About" page.

* As a user, I want to see what the events look like.
   - A user can view pictures of previous events, navigating to the "Gallery" page.

* As a user, I want to be able to get in touch with the organization. 
...
* Landing Page.
   - Verify that the animationn is not overflowing the page and is centered with the text.
...
* Gallery.
   ...
   - Verify that the images are not overlapping or stacked on top of each other.
...
[navbar-error](./assets/readme-images/navbarerror.png)
